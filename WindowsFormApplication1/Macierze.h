...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBoxDzia³ania->Size = System::Drawing::Size(353, 110);
			this->groupBoxDzia³ania->TabIndex = 9;
			this->groupBoxDzia³ania->TabStop = false;
			this->groupBoxDzia³ania->Text = L"Dzia³ania:";
			this->toolTip1->SetToolTip(this->groupBoxDzia³ania, L"Odœwie¿aj ka¿d¹ zmianê przed pokazaniem wyniku");
			// 
			// radioButtonTransponowanie
			// 
			this->radioButtonTransponowanie->AutoSize = true;
			this->radioButtonTransponowanie->Location = System::Drawing::Point(135, 65);
			...
			this->radioButtonTransponowanie->Size = System::Drawing::Size(213, 21);
			...
			this->groupBoxB->Location = System::Drawing::Point(513, 55);
			...
			this->groupBoxMB->Location = System::Drawing::Point(845, 54);
			...
			this->groupBoxMB2->Location = System::Drawing::Point(845, 191);
			...
			this->buttonA->Location = System::Drawing::Point(140, 276);
			this->buttonA->Margin = System::Windows::Forms::Padding(4);
			this->buttonA->Name = L"buttonA";
			this->buttonA->Size = System::Drawing::Size(113, 55);
			this->buttonA->TabIndex = 15;
			this->buttonA->Text = L"Odœwie¿ okna";
			...
			this->LabelAW->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->LabelAW->Location = System::Drawing::Point(23, 491);
			this->LabelAW->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			...
			this->labelZnak->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->labelZnak->Location = System::Drawing::Point(472, 153);
			this->labelZnak->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->labelZnak->Name = L"labelZnak";
			this->labelZnak->Size = System::Drawing::Size(0, 31);
			...
			this->groupBox2->Location = System::Drawing::Point(396, 324);
			this->groupBox2->Margin = System::Windows::Forms::Padding(4);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Padding = System::Windows::Forms::Padding(4);
			this->groupBox2->Size = System::Drawing::Size(324, 213);
			...
			this->C44->Location = System::Drawing::Point(229, 144);
			this->C44->Margin = System::Windows::Forms::Padding(4);
			this->C44->Name = L"C44";
			this->C44->ReadOnly = true;
			this->C44->Size = System::Drawing::Size(56, 22);
			...
			this->C12->Location = System::Drawing::Point(99, 48);
			this->C12->Margin = System::Windows::Forms::Padding(4);
			this->C12->Name = L"C12";
			this->C12->ReadOnly = true;
			this->C12->Size = System::Drawing::Size(56, 22);
			...
			this->C43->Location = System::Drawing::Point(164, 144);
			this->C43->Margin = System::Windows::Forms::Padding(4);
			this->C43->Name = L"C43";
			this->C43->ReadOnly = true;
			this->C43->Size = System::Drawing::Size(56, 22);
			...
			this->C11->Location = System::Drawing::Point(33, 48);
			this->C11->Margin = System::Windows::Forms::Padding(4);
			this->C11->Name = L"C11";
			this->C11->ReadOnly = true;
			this->C11->Size = System::Drawing::Size(56, 22);
			...
			this->C42->Location = System::Drawing::Point(99, 144);
			this->C42->Margin = System::Windows::Forms::Padding(4);
			this->C42->Name = L"C42";
			this->C42->ReadOnly = true;
			this->C42->Size = System::Drawing::Size(56, 22);
			...
			this->C13->Location = System::Drawing::Point(164, 48);
			this->C13->Margin = System::Windows::Forms::Padding(4);
			this->C13->Name = L"C13";
			this->C13->ReadOnly = true;
			this->C13->Size = System::Drawing::Size(56, 22);
			...
			this->C41->Location = System::Drawing::Point(33, 144);
			this->C41->Margin = System::Windows::Forms::Padding(4);
			this->C41->Name = L"C41";
			this->C41->ReadOnly = true;
			this->C41->Size = System::Drawing::Size(56, 22);
			...
			this->C14->Location = System::Drawing::Point(229, 48);
			this->C14->Margin = System::Windows::Forms::Padding(4);
			this->C14->Name = L"C14";
			this->C14->ReadOnly = true;
			this->C14->Size = System::Drawing::Size(56, 22);
			...
			this->C34->Location = System::Drawing::Point(229, 112);
			this->C34->Margin = System::Windows::Forms::Padding(4);
			this->C34->Name = L"C34";
			this->C34->ReadOnly = true;
			this->C34->Size = System::Drawing::Size(56, 22);
			...
			this->C21->Location = System::Drawing::Point(33, 80);
			this->C21->Margin = System::Windows::Forms::Padding(4);
			this->C21->Name = L"C21";
			this->C21->ReadOnly = true;
			this->C21->Size = System::Drawing::Size(56, 22);
			...
			this->C33->Location = System::Drawing::Point(164, 112);
			this->C33->Margin = System::Windows::Forms::Padding(4);
			this->C33->Name = L"C33";
			this->C33->ReadOnly = true;
			this->C33->Size = System::Drawing::Size(56, 22);
			...
			this->C22->Location = System::Drawing::Point(99, 80);
			this->C22->Margin = System::Windows::Forms::Padding(4);
			this->C22->Name = L"C22";
			this->C22->ReadOnly = true;
			this->C22->Size = System::Drawing::Size(56, 22);
			...
			this->C32->Location = System::Drawing::Point(99, 112);
			this->C32->Margin = System::Windows::Forms::Padding(4);
			this->C32->Name = L"C32";
			this->C32->ReadOnly = true;
			this->C32->Size = System::Drawing::Size(56, 22);
			...
			this->C23->Location = System::Drawing::Point(164, 80);
			this->C23->Margin = System::Windows::Forms::Padding(4);
			this->C23->Name = L"C23";
			this->C23->ReadOnly = true;
			this->C23->Size = System::Drawing::Size(56, 22);
			...
			this->C31->Location = System::Drawing::Point(33, 112);
			this->C31->Margin = System::Windows::Forms::Padding(4);
			this->C31->Name = L"C31";
			this->C31->ReadOnly = true;
			this->C31->Size = System::Drawing::Size(56, 22);
			...
			this->C24->Location = System::Drawing::Point(229, 80);
			this->C24->Margin = System::Windows::Forms::Padding(4);
			this->C24->Name = L"C24";
			this->C24->ReadOnly = true;
			this->C24->Size = System::Drawing::Size(56, 22);
			this->C24->TabIndex = 23;
			this->C24->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(728, 390);
			this->button1->Margin = System::Windows::Forms::Padding(4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(147, 68);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(261, 274);
			...
			this->ClientSize = System::Drawing::Size(989, 551);
...
#pragma endregion
	...
	private: System::Void radioButtonDodawanie_CheckedChanged(System::Object^  sender, System::EventArgs^  e) {
		...
		groupBoxMB->Enabled = false;
		if (radioButtonK2_B->Checked || radioButtonK3_B->Checked || radioButtonK4_B->Checked)
		{
			radioButtonK2_B->Checked = false;
			radioButtonK3_B->Checked = false;
			radioButtonK4_B->Checked = false;
		}
	...
	if (radioButtonDodawanie->Checked || radioButtonOdejmowanie->Checked || radioButtonMnozenie->Checked || radioButtonTransponowanie->Checked)
	{
		...
		if (radioButtonMnozenie->Checked)
		{
			...
			{
				LabelAW->Text = "Error: Kliknij ponownie 'odœwie¿'";
			}
